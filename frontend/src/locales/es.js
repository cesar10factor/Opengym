...
export default {
  ...
  'Replace': 'Reemplazar',
  'Replace {0}?': '¿Reemplazar {0}?',
  'Which exercise in this superset do you want to replace?': '¿Qué ejercicio de esta superserie quieres reemplazar?',
  'Replaced {0} with {1}': '{0} reemplazado por {1}',
  ...
  'Strava': 'Strava',
  'Connect Strava': 'Conectar Strava',
  'Upload finished workouts automatically.': 'Sube los entrenamientos terminados automáticamente.',
  'Connected to Strava': 'Conectado a Strava',
  'Finished workouts upload automatically.': 'Los entrenamientos terminados se suben automáticamente.',
  'Disconnect': 'Desconectar',
  'Disconnect Strava?': '¿Desconectar Strava?',
  'openGym will stop uploading finished workouts to your Strava account. Anything already there stays.': 'openGym dejará de subir los entrenamientos terminados a tu cuenta de Strava. Lo que ya se subió se queda ahí.',
