...
export default {
  ...
  'Replace': 'Substituir',
  'Replace {0}?': 'Substituir {0}?',
  'Which exercise in this superset do you want to replace?': 'Que exercício desta supersérie queres substituir?',
  'Replaced {0} with {1}': '{0} substituído por {1}',
