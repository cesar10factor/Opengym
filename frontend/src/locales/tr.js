...
export default {
  ...
  'Replace': 'Değiştir',
  'Replace {0}?': '{0} değiştirilsin mi?',
  'Which exercise in this superset do you want to replace?': 'Bu süper sette hangi egzersizi değiştirmek istiyorsun?',
  'Replaced {0} with {1}': '{0} yerine {1} kondu',
